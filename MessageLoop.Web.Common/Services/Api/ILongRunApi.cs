...
namespace MessageLoop.Web.Common.Services.Api
{
    public interface ILongRunApi<T> where T : LongRunItem, new()
    {
        ...
        /// <para>See <see cref="MessageLoop.Web.Common.Controllers.v1.LongRunController.GetLongRunStatus(Guid)"/></para>
        /// </summary>
        ...
        /// <para>See <see cref="MessageLoop.Web.Common.Controllers.v1.LongRunController.GetAll"/></para>
        /// </summary>
        ...
        /// <para>See <see cref="MessageLoop.Web.Common.Controllers.v1.LongRunController.Abort(Guid)"/></para>
        /// </summary>
